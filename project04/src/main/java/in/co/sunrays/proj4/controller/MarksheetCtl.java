...
public class MarksheetCtl extends BaseCtl {
    ...
    protected boolean validate(HttpServletRequest request) {
        ...
        if(DataValidator.isNull(request.getParameter("physics"))){
        	request.setAttribute("physics",PropertyReader.getValue("error.require","Mark"));
        	pass=false;
        }
        ...
        if (DataValidator.isNull(request.getParameter("studentId"))||request.getParameter("studentId").equals("null")) {
        	System.out.println("Parameter"+request.getParameter("studentId"));
           request.setAttribute("studentId",PropertyReader.getValue("error.select","Student Name"));
            pass = false;
        }
