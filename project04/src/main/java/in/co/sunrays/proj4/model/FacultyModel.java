...
public class FacultyModel {
	...
	public long add(FacultyBean bean) throws ApplicationException, DuplicateRecordException {
		...
		CoursesBean courseBean = courseModel.findByPK(bean.getCourseId());
		bean.setCourseName(courseBean.getName());
		
		SubjectsModel subjectModel = new SubjectsModel();
		SubjectsBean subjectBean = subjectModel.findByPK(bean.getSubjectId());
	...
	public void update(FacultyBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			pstmt.setString(7, bean.getFirst_name());
			pstmt.setString(8, bean.getLast_name());
			...
			pstmt.setString(12, bean.getMobile_no());
