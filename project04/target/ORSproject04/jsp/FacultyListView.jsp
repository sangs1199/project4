...
<body bgcolor="">
  ...
  <h2><font color="green"><%=ServletUtility.getSuccessMessage(request)%></font></h2>
		...
		<form action="<%=ORSView.FACULTY_LIST_CTL%>" name="frm" method="post">
			...
			<table width="100%">
				<tr>
					<td align="left"><label>Course:</label> <%=HTMLUtility.getList("courseId", String.valueOf(bean.getCourseId()), courseList)%>
						&nbsp; 
						...
						&nbsp;<input style="padding: 5px; width: 100px;" type="submit" name="operation" value="<%=FacultyListCtl.OP_RESET%>"></td>
