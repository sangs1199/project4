...
public class SubjectsModel {
    ...
    private static Logger log = Logger.getLogger(SubjectsModel.class);
     ...
     * 
     */
    public long add(SubjectsBean bean) throws ApplicationException,
        ...
        CoursesBean CourseBean = cModel.findByPK(bean.getCourseId());
        bean.setCourseName(CourseBean.getName());

        SubjectsBean duplicateName = findByName(bean.getName());
        int pk = 0;
     ...
     * @throws DatabaseException
     */
    public void delete(SubjectsBean bean) throws ApplicationException {
    ...
    public SubjectsBean findByName(String name) throws ApplicationException {
    ...
    public SubjectsBean findByPK(long pk) throws ApplicationException {
    ...
    public void update(SubjectsBean bean) throws ApplicationException,
            DuplicateRecordException {
        log.debug("Model update Started");
        Connection conn = null;

        SubjectsBean beanExist = findByName(bean.getName());
    ...
    public List search(SubjectsBean bean) throws ApplicationException {
    ...
    public List search(SubjectsBean bean, int pageNo, int pageSize)
