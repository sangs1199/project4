 ...
 * Generated at: 2019-05-06 11:33:48 UTC
...
public final class FacultyListView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("in.co.sunrays.proj4.model.CoursesModel");
    _jspx_imports_classes.add("java.util.Iterator");
    _jspx_imports_classes.add("in.co.sunrays.proj4.model.CollegeModel");
    ...
    _jspx_imports_classes.add("in.co.sunrays.proj4.model.FacultyModel");
...
if(list.size()!=0){ 
      ...
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td align=\"center\"><label>Course:</label> ");
      out.print(HTMLUtility.getList("courseId", String.valueOf(bean.getCourseId()), courseList));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t&emsp; \r\n");
      out.write("\t\t\t\t\t\t<label>Full Name:</label> ");
      out.print(HTMLUtility.getList("facultyId", String.valueOf(bean.getId()), facultyList));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t&emsp; \r\n");
      out.write("\t\t\t\t\t\t<label>First Name :</label> <input type=\"text\" name=\"firstName\" placeholder=\"Enter First Name\" value=\"");
      out.print(ServletUtility.getParameter("firstName", request));
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t&emsp;\r\n");
      out.write("\t\t\t\t\t\t<label>Last Name :</label> <input type=\"text\" name=\"lastName\" placeholder=\"Enter Last Name\" value=\"");
      out.print(ServletUtility.getParameter("lastName", request));
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t&emsp;\r\n");
      out.write("\t\t\t\t\t\t<label> <input style=\"padding: 5px; width: 100px;\" type=\"submit\" name=\"operation\"\r\n");
      out.write("\t\t\t\t\t\tvalue=\"");
      out.print(FacultyListCtl.OP_SEARCH);
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t&emsp;<input style=\"padding: 5px; width: 100px;\" type=\"submit\" name=\"operation\" value=\"");
	...
	FacultyModel model = new FacultyModel();
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(bean1.getFirst_name());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(bean1.getLast_name());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(bean1.getEmail() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(bean1.getQualification() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(bean1.getCollegeName() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(DataUtility.getDateString(bean1.getDob()));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(bean1.getMobile_no() );
      out.write("</td>\r\n");
