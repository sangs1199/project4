...
public class StudentModel {
    ...
    public long add(StudentBean bean) throws ApplicationException,
        ...
        try {
            ...
            pstmt.setInt(1, pk);
            pstmt.setLong(2, bean.getCollegeId());  System.out.println(bean.getCollegeId());
            pstmt.setString(3, bean.getCollegeName());System.out.println(bean.getCollegeName());
            pstmt.setString(4, bean.getFirstName());System.out.println(bean.getFirstName());
            pstmt.setString(5, bean.getLastName());System.out.println(bean.getLastName());
            pstmt.setDate(6, new java.sql.Date(bean.getDob().getTime()));System.out.println(new java.sql.Date(bean.getDob().getTime()));
            pstmt.setString(7, bean.getMobileNo());System.out.println(bean.getMobileNo());
            pstmt.setString(8, bean.getEmail());System.out.println(bean.getEmail());
