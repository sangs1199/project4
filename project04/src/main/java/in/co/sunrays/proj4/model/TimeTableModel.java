...
public class TimeTableModel {
	...
	public long add(TimeTableBean bean) throws ApplicationException, DuplicateRecordException {
		...
		SubjectsModel sModel = new SubjectsModel();
		SubjectsBean subjectBean = sModel.findByPK(bean.getSubjectId());
		...
		TimeTableBean duplicatename2 = findTimeTableDuplicacy(bean.getCourseId(),bean.getSubjectId(),bean.getExamDate());
				int pk = 0;
				 ...
				 if (duplicatename2!=null){
					 throw new DuplicateRecordException("Time Table Not Allowed For This Semester");
				 }
...
System.out.println("update start");
	...
	public TimeTableBean findTimeTableDuplicacy(Long courseId, 
		...
		log.debug("Method FindTimeTable of Model TimeTable started");
		System.out.println("in findTimeTable1");
		StringBuffer sql = new StringBuffer(
	...
	private TimeTableBean findTimeTableDuplicacy(long courseId, long subjectId, Date examDate) throws ApplicationException {
		log.debug("Method FindTimeTable of Model TimeTable started");
		System.out.println("in find timetable2");
		StringBuffer sql = new StringBuffer(
