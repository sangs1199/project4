...
public interface ORSView {
    ...
    public String COURSES_VIEW = PAGE_FOLDER + "/CourseView.jsp";    
    public String FACULTY_VIEW = PAGE_FOLDER + "/FacultyView.jsp";
    public String SUBJECT_VIEW = PAGE_FOLDER + "/SubjectView.jsp";
    public String TIMETABLE_VIEW = PAGE_FOLDER + "/TimeTableView.jsp";

    public String COURSES_LIST_VIEW = PAGE_FOLDER + "/CourseListView.jsp";    
    public String FACULTY_LIST_VIEW = PAGE_FOLDER + "/FacultyListView.jsp";
    public String SUBJECTS_LIST_VIEW = PAGE_FOLDER + "/SubjectListView.jsp";
    ...
    public String COURSES_CTL = APP_CONTEXT + "/ctl/CourseCtl";    
    public String FACULTY_CTL = APP_CONTEXT + "/ctl/FacultyCtl";
    public String SUBJECTS_CTL = APP_CONTEXT + "/ctl/SubjectCtl";
    public String TIMETABLE_CTL = APP_CONTEXT + "/ctl/TimeTableCtl";

    public String COURSES_LIST_CTL = APP_CONTEXT + "/ctl/CoursesListCtl";    
    public String FACULTY_LIST_CTL = APP_CONTEXT + "/ctl/FacultyListCtl";
    public String SUBJECTS_LIST_CTL = APP_CONTEXT + "/ctl/SubjectListCtl";
