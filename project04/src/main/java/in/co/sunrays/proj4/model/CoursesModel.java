...
public class CoursesModel {
	...
	private static Logger log = Logger.getLogger(CoursesModel.class);
	 ...
	 * 
	 */
	public long add(CoursesBean bean) throws ApplicationException, DuplicateRecordException {
		log.debug("Model add Started");
		Connection conn = null;
		int pk = 0;

		CoursesBean duplicateCourseName = findByName(bean.getName());
	 ...
	 * @throws ApplicationException
	 */
	public void delete(CoursesBean bean) throws ApplicationException {
	 ...
	 * @throws ApplicationException
	 */
	public CoursesBean findByName(String name) throws ApplicationException {
	 ...
	 * @throws ApplicationException
	 */
	public CoursesBean findByPK(long pk) throws ApplicationException {
	 ...
	 * @throws DuplicateRecordException
	 */
	public void update(CoursesBean bean) throws ApplicationException, DuplicateRecordException {
		log.debug("Model update Started");
		Connection conn = null;

		CoursesBean beanExist = findByName(bean.getName());
	 ...
	 * @throws ApplicationException
	 */
	public List search(CoursesBean bean, int pageNo, int pageSize) throws ApplicationException {
	 ...
	 * @throws ApplicationException
	 */
	public List search(CoursesBean bean) throws ApplicationException {
