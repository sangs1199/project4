...
<form action="<%=ORSView.SUBJECTS_CTL%>" method="post">
       <div> <%@ include file="Header.jsp"%></div>
<script type="text/javascript"></script>
		
		
        <jsp:useBean id="bean" class="in.co.sunrays.proj4.bean.SubjectsBean"
          ...
          <center>
            ...
            <table align="center" style="margin-left:35% ">
                  <tr>
                    ...
                    String.valueOf(bean.getCourseId()), l)%><font color="red"> <%=ServletUtility.getErrorMessage("courseId", request)%></font></td>
                </tr>
                 ...
                 <tr>
              	...
              	<tr>
						...
						<td><input type="submit" name="operation"
							...
							value="<%=(bean.getId()<=0)?SubjectCtl.OP_RESET:SubjectCtl.OP_CANCEL%>" style="width: 97px;"></td>
					</tr>
				</table>
